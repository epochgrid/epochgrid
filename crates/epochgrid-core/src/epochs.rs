...
mod tests {
    ...
    fn third_device_commit_rollback_epoch_floor_and_restart() -> Result<()> {
        ...
        *last ^= 1;
        ...
        bob.connection
            .execute_batch("DROP TABLE group_join_epochs; DROP TABLE epochgrid_migrations; DROP TABLE device_trust; DROP TABLE transparency_state; DROP TABLE trust_alert; DROP TABLE revoked_devices; DROP TABLE revocation_checkpoint; DROP TABLE blocked_outbox; DROP TABLE group_coordinators; DROP TABLE recovery_metadata; DROP TABLE attachments; DROP TABLE receipt_messages; DROP TABLE device_receipts; DROP TABLE message_events; DROP TABLE participant_events;")?;
